...
PPint_interactions = pd.read_csv(
    "/work3/s232958/data/PPint_DB/disordered_interfaces_no_cutoff_filtered_nonredundant80_3å_5.csv.gz",
    index_col=0
...
PPint_interactions_df_NEW_sample.to_csv("/work3/s232958/data/PPint_DB/averageLL_pPLL_PPint.csv", index=False)
